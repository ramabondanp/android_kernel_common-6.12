...
HOSTCC_NO_CCACHE	= $(LLVM_PREFIX)clang$(LLVM_SUFFIX)
else
HOSTCC	= $(CCACHE) gcc
HOSTCXX	= $(CCACHE) g++
HOSTCC_NO_CCACHE	= gcc
endif
HOSTRUSTC = rustc
...
export ARCH SRCARCH CONFIG_SHELL BASH HOSTCC HOSTCC_NO_CCACHE KBUILD_HOSTCFLAGS CROSS_COMPILE LD CC HOSTPKG_CONFIG
